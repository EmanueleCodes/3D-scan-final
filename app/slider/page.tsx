...
export default function SliderPage() {
     ...
     *
     * All styles are defined as inline objects to avoid external CSS dependencies.
     * This approach ensures the component is self-contained and portable.
     *
     * Layout Strategy:
     * - Wrapper: Fixed container with overflow control
     * - Carousel: Absolute positioned flex container for horizontal layout
     * - Boxes: Individual slides with fixed widths and responsive positioning
     */
    const styles = {
        body: {
    ...
    return (
        ...
        `}
            ...
            <div ref={wrapperRef} style={styles.wrapper}>
                <div style={styles.carousel}>{boxes}</div>
            </div>
        </div>
    )
}
